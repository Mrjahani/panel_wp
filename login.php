                        ...
                        <form class="text-left" method="post">
                            ...
                            <div class="form">
                                ...
                                <div id="username-field" class="field-wrapper input">
                                    ...
                                    <input id="email" name="email" type="text" class="form-control" placeholder="نام کاربری">
                                </div>

                                <div id="password-field" class="field-wrapper input mb-2">
                                    <div class="d-flex justify-content-between">
                                        <label for="password">رمزعبور</label>
                                        <a href="#" class="forgot-pass-link">رمز عبور را فراموش کرده اید؟</a>
                                    </div>
                             ...
                             <!--    <div class="social">
                                ...
                                <p class="signup-link">حساب ندارید؟ <a href="register.php"> یک حساب کاربری ایجاد کنید</a></p>
